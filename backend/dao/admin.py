...
class AdminDAO:
    ...
    def getAdminById(self, admin_id):
        cursor = self.conn.cursor()
        query = "Select * from users Natural Inner Join admin Natural Inner Join user_phone where admin_id = %s;"
    ...
    def getAdminsByFirstname(self, admin_firstname):
        cursor = self.conn.cursor()
        query = "Select * from users Natural Inner Join admin Natural Inner Join user_phone where user_firstname = %s;"
    ...
    def getAdminsByLastname(self, admin_lastname):
        cursor = self.conn.cursor()
        query = "Select * from users Natural Inner Join admin Natural Inner Join user_phone where user_lastname = %s;"
    ...
    def getAdminsByEmail(self, admin_email):
        cursor = self.conn.cursor()
        query = "Select * from users Natural Inner Join admin Natural Inner Join user_phone where user_email = %s;"
    ...
    def getAdminsByFirstnameAndLastname(self, admin_firstname, admin_lastname):#verify if is need to change the var admin_name to user_name
        cursor = self.conn.cursor()
        query = "Select * from users Natural Inner Join admin Natural Inner Join user_phone where user_firstname = %s and user_lastname = %s;"
    ...
    def getAdminsByDateOfBirth(self, admin_date_birth):
        cursor = self.conn.cursor()
        query = "Select * from users Natural Inner Join admin Natural Inner Join user_phone where user_date_birth = %s;"
