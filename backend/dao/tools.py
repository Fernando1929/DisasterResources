...
# tools = tool_id, resource_id, supplier_id, tool_address, tool_name, tool_brand, tool_quantity, tool_price, 
#           tool_material, tool_condition, tool_pwtype
    def getAllTools(self):
        result = [[1, 1, 1, "Plaza Fernando Pacheco, Yauco, PR", "Wrench", "Craftsman", 5, 40.00, "stainless steel", "New", "None"]]
        return result
