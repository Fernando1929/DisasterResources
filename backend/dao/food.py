...
# food = food_id, resource_id, supplier_id, food_address, food_name, food_brand, food_quantity, food_price, 
#           food_category, food_container, food_type, food_ounces, food_expdate
    def getAllFoods(self):
        result = [[1, 1, 1, "Plaza Fernando Pacheco, Yauco, PR", "Canned peaches", "Del Monte", 12, 10.00, "fruit", "aluminum", "canned", 8, "12/31/2020"]]
        return result
