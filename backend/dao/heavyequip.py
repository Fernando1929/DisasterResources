class HeavyEquipDAO:
    ...
    def getAllHeavyEquip(self):
        result = [
            ...
            [2, 2, 2, "heavy_equipment", "Heavy Equipment", "Clark", 1, 1500.00, "Elevator", "EC500-800 Type E", "Used"]
        ]
        return result
    ...
    def getAllReservedHeavyEquip(self):
        result = [
            [1, 1, 1, "heavy_equipment", "Heavy Equipment", "Caterpillar", 1, 0.00, "Excavator", "320D", "Used"],
            [2, 2, 2, "heavy_equipment", "Heavy Equipment", "Clark", 1, 0.00, "Elevator", "EC500-800 Type E", "Used"]
        ]
        return result
    ...
    def getHeavyEquipById(self, heavyequip_id):
        result = [1, 1, 1, "heavy_equipment", "Heavy Equipment", "Caterpillar", 1, 125000.00, "Excavator", "320D", "Used"]
        return result
    ...
    def getAllAvailableHeavyEquipBySupplierId(self, supplier_id):
        result = [
            [1, 1, 1, "heavy_equipment", "Heavy Equipment", "Caterpillar", 1, 125000.00, "Excavator", "320D", "Used"],
            [2, 2, 1, "heavy_equipment", "Heavy Equipment", "Clark", 1, 1500.00, "Elevator", "EC500-800 Type E", "Used"]
        ]
        return result
    ...
    def getAllReservedHeavyEquipBySupplierId(self, supplier_id):
        result = [
            [1, 1, 1, "heavy_equipment", "Heavy Equipment", "Caterpillar", 1, 0.00, "Excavator", "320D", "Used"],
            [2, 2, 1, "heavy_equipment", "Heavy Equipment", "Clark", 1, 0.00, "Elevator", "EC500-800 Type E", "Used"]
        ]
        return result
