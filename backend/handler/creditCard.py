...
class CreditCardHandler:
    ...
    def build_athMovil_attributes(self, creditcard_id, payment_id, user_id, creditcard_number, creditcard_ccv, creditcard_exp_date):
        result = {}
    ...
    def searchCreditCard(self, args):
        ...
        if (len(args) == 1) and creditcard_number:
    ...
    def updateCreditCard(self, creditcard_id, json):
        ...
        if not creditcard_dao.getCreditCardById(creditcard_id):
            ...
            if user_id and creditcard_name and creditcard_number and creditcard_ccv and creditcard_exp_date:
                ...
                result = self.build_athMovil_attributes(creditcard_id, payment_id, user_id, creditcard_name, creditcard_number, creditcard_ccv, creditcard_exp_date)
