...
class MedicineHandler:
    ...
    def build_medicine_attributes(self, med_id, resource_id, supplier_id, category, med_name, med_brand, med_quantity, med_price, med_type, med_dose, med_prescript, med_expdate):
        result = {}
    ...
    def insertMedicine(self, json):
        ...
        if supplier_id and category and med_name and med_brand and med_quantity and (med_price>=0) and med_type and med_dose and med_prescript and med_expdate:
            resource_dao = ResourceDAO()
            resource_id = resource_dao.insert(supplier_id, category, med_name, med_brand, med_quantity, med_price)
            med_dao = MedicineDAO()
            med_id = med_dao.insert(resource_id, med_type, med_dose, med_prescript, med_expdate)
            result = self.build_medicine_attributes(med_id, resource_id, supplier_id, category, med_name, med_brand, med_quantity, med_price, med_type, med_dose, med_prescript, med_expdate)
    ...
    def updateMedicine(self, med_id, json):
        ...
        if not med_dao.getMedicineById(med_id):
            ...
            if supplier_id and category and med_name and med_brand and med_quantity and med_price and med_type and med_dose and med_prescript and med_expdate:
                resource_id = med_dao.update(med_id, med_type, med_dose, med_prescript, med_expdate)
                resource_dao = ResourceDAO()
                resource_dao.update(resource_id, supplier_id, category, med_name, med_brand, med_quantity, med_price)
